...
Outputs (experiments/archive/scale-old[-<tag>]/):
...
def parse_args():
    ...
    p.add_argument("--source-dir", type=Path, default=Path("experiments/archive/repro-check"))
    p.add_argument("--output", type=Path, default=Path("experiments/archive/scale-old"))
