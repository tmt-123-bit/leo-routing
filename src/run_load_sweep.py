...
Outputs (experiments/archive/load-old/):
...
def main():
    ...
    ap.add_argument("--output", type=Path, default=Path("experiments/archive/load-old"))
    ...
    for label, ini, exo in points:
        ...
        fct = wrapper_factory(scenario, ini, exo, actors[0][2])
