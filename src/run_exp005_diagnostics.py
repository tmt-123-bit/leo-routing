...
def parse_args():
    ...
    parser.add_argument("--exp004", type=Path, default=Path("experiments/archive/EXP-004"))
    parser.add_argument("--output", type=Path, default=Path("experiments/archive/EXP-005"))
