...
Reads experiments/sweep-reward/aggregate_sensitivity.csv and produces a 2x2
...
Usage:
  python make_reward_sensitivity_figure.py \
      --input experiments/sweep-reward/aggregate_sensitivity.csv --outdir figures
"""
...
def main():
    ...
    ap.add_argument("--input", default="experiments/sweep-reward/aggregate_sensitivity.csv")
