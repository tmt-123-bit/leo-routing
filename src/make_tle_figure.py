...
Usage:
  python make_tle_figure.py \
      --tle experiments/archive/TLE-NOLIFE-FULL/aggregate_metrics.csv \
      --realism experiments/archive/realism-nolife/aggregate_realism.csv \
      --outdir figures
"""
...
def main():
    ...
    ap.add_argument("--tle", default="experiments/archive/TLE-NOLIFE-FULL/aggregate_metrics.csv")
    ap.add_argument("--realism", default="experiments/archive/realism-nolife/aggregate_realism.csv")
