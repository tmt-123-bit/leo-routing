...
Outputs (experiments/qscale-transfer/):
...
def main():
    ...
    ap.add_argument("--tables-dir", type=Path,
                    default=Path("experiments/eval-main/q_routing_models"))
    ap.add_argument("--output", type=Path, default=Path("experiments/qscale-transfer"))
    ...
    (args.output / "manifest.json").write_text(json.dumps({
        ...
        "note": "join with sweep-scale transfer_matrix.csv on (target_scale, workload_seed) "
