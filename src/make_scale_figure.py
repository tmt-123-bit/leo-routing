...
Reads experiments/archive/scale-old/aggregate_scale.csv and produces a two-panel figure:
...
Usage:
  python make_scale_figure.py --input experiments/archive/scale-old/aggregate_scale.csv \
                              --outdir figures
"""
...
def main():
    ...
    ap.add_argument("--input", default="experiments/archive/scale-old/aggregate_scale.csv")
