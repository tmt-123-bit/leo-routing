...
Outputs (experiments/archive/realism-old/):
...
Usage:
  python run_realism_transfer.py \
      --source-dir experiments/archive/repro-check \
      --output experiments/archive/realism-old --scenario medium_load --device cpu
"""
...
def main():
    ...
    ap.add_argument("--source-dir", type=Path, default=Path("experiments/archive/repro-check"))
    ap.add_argument("--output", type=Path, default=Path("experiments/archive/realism-old"))
