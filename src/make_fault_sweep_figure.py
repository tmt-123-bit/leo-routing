...
Reads experiments/archive/fault-old/aggregate_fault.csv and produces a two-panel figure:
...
Usage:
  python make_fault_sweep_figure.py --input experiments/archive/fault-old/aggregate_fault.csv \
                                    --matrix experiments/archive/fault-old/fault_matrix.csv \
                                    --outdir figures
"""
...
def main():
    ...
    ap.add_argument("--input", default="experiments/archive/fault-old/aggregate_fault.csv")
    ap.add_argument("--matrix", default="experiments/archive/fault-old/fault_matrix.csv")
