...
Reads the headline aggregate (experiments/archive/repro-check/aggregate_metrics.csv)
...
Usage:
  python make_fairness_figure.py \
      --input experiments/archive/repro-check/aggregate_metrics.csv --outdir figures
"""
...
def main():
    ...
    ap.add_argument("--input", default="experiments/archive/repro-check/aggregate_metrics.csv")
