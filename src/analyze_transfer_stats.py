...
Works on both:
  experiments/archive/realism-old/realism_matrix.csv   (group = scenario/topology)
  experiments/archive/scale-old/transfer_matrix.csv    (group = scenario/scale label)

Usage:
  python analyze_transfer_stats.py \
      --input experiments/archive/realism-old/realism_matrix.csv \
      --mappo-policy mappo_realism_transfer \
      --group-col scenario --output experiments/archive/realism-old/paired_stats.csv

  python analyze_transfer_stats.py \
      --input experiments/archive/scale-old/transfer_matrix.csv \
      --mappo-policy mappo_transfer_n24 \
      --group-col scenario --output experiments/archive/scale-old/paired_stats.csv
"""
