...
Reads qscale-transfer/qscale_matrix.csv (q_routing_transfer / q_routing_retrained /
q_routing_n24_indist) and sweep-scale/transfer_matrix.csv (mappo_transfer_n24
...
def main():
    ...
    ap.add_argument("--qscale", default="experiments/qscale-transfer/qscale_matrix.csv")
    ap.add_argument("--scale", default="experiments/sweep-scale/transfer_matrix.csv")
