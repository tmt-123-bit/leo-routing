...
Reads experiments/archive/load-old/aggregate_load.csv and produces a two-panel figure:
...
Usage:
  python make_load_sweep_figure.py --input experiments/archive/load-old/aggregate_load.csv \
                                   --outdir figures
"""
...
def main():
    ...
    ap.add_argument("--input", default="experiments/archive/load-old/aggregate_load.csv")
