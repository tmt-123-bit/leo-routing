...
-----
    py compute_mde.py \
        --episodes experiments/archive/EXP-004-FULL/episode_metrics.csv \
        --output   experiments/archive/EXP-004-FULL/mde_report.csv
...
def main() -> None:
    ...
    parser.add_argument(
        "--episodes",
        type=Path,
        default=Path("experiments/archive/EXP-004-FULL/episode_metrics.csv"),
    )
    parser.add_argument(
        "--output",
        type=Path,
