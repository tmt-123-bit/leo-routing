...
卫星级 MAPPO 使用 `cleanmarl_leo_multiagent_wrapper.py`：`n_agents=24`、Actor observation `(24,182)`、action mask `(24,7)`、centralized graph state 6941 维。图状态按 5 个全局特征、`24×25` 节点特征和 `24×24×11` 边特征解析；只有 `env_type=leo_multi` 才能用于多 Agent/CTDE 语义。
